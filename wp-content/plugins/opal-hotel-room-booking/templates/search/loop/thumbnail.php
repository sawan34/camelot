...
<div class="opalhotel-catalog-thumbnail">
	<div class="room-thumbnail">
		<a href="<?php echo esc_attr( wp_get_attachment_url( get_post_thumbnail_id( $room->id ) ) ); ?>" class="opalhotel-lightbox" data-rel="opalhotel-fancybox-<?php echo esc_attr( $room->id ) ?>">
