...
class HotelBookingPlugin {
	...
	static public function deactivate(){
		...
		$mphbActiveCount = (int)is_plugin_active( 'motopress-hotel-booking/motopress-hotel-booking.php' );
		$mphbActiveCount += (int)is_plugin_active( 'motopress-hotel-booking-lite/motopress-hotel-booking.php' );
