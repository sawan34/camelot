...
Tags: hotel, booking, reservation, calendar, vacation
...
* [Demo and a free backend trial](https://hbdemo.getmotopress.com/)
...
Get [MotoPress Hotel Booking](https://motopress.com/products/hotel-booking/?utm_source=wp-org&utm_medium=pro-link&utm_campaign=hotel-booking-lite&utm_content=motopress-hotel-booking) Pro.

Premium WordPress themes where the Pro version of the [WordPress booking plugin](https://motopress.com/products/hotel-booking/?utm_source=wp-org&utm_medium=pro-link&utm_campaign=hotel-booking-lite&utm_content=wordpress-booking-plugin) is included for free:

* [Oceanica](https://motopress.com/products/oceanica/) - an elegant and lightweight WordPress hotel theme.
* [Villagio](https://motopress.com/products/villagio/) - a property rental WordPress theme for multiple accommodations.

Hotel Booking plugin is also optimized for Elementor to work effectively with this page builder.
[Hotel Booking & Elementor Integration](https://wordpress.org/plugins/mphb-elementor/) helps to speed up the work with your hotel website based on Elementor.
